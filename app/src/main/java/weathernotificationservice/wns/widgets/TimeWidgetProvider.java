package weathernotificationservice.wns.widgets;
...
import weathernotificationservice.wns.BuildConfig;
import weathernotificationservice.wns.R;
import weathernotificationservice.wns.activities.MainActivity;
...
public class TimeWidgetProvider extends AbstractWidgetProvider {
    ...
    private static final String ACTION_UPDATE_TIME = "weathernotificationservice.wns.UPDATE_TIME";
