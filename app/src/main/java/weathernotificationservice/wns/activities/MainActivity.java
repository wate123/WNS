...
import weathernotificationservice.wns.AlarmReceiver;
import weathernotificationservice.wns.Constants;
import weathernotificationservice.wns.R;
import weathernotificationservice.wns.adapters.ViewPagerAdapter;
import weathernotificationservice.wns.adapters.WeatherRecyclerAdapter;
import weathernotificationservice.wns.fragments.RecyclerViewFragment;
import weathernotificationservice.wns.models.Weather;
import weathernotificationservice.wns.tasks.GenericRequestTask;
import weathernotificationservice.wns.tasks.ParseResult;
import weathernotificationservice.wns.tasks.TaskOutput;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private void aboutDialog() {
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("Weather Notification Service");
