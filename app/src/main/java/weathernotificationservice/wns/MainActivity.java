...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get the weather API for a location
        task.execute("http://samples.openweathermap.org/data/2.5/weather?lat=" + String.valueOf(lat) + "lon=" + String.valueOf(lon)+"&appid=b8177cd4b0b9b513d0a187446b775640");
